#!/usr/bin/env python3
"""
Script to generate AGENT_STRUCTURE.md with Mermaid diagram.

This script creates comprehensive documentation showing:
- All five agents (Strategist, Researcher, Writer, Editor, Archivist)
- Two-phase orchestration flow (Strategy Phase and Execution Phase)
- Neon database integration via Kiro Power
...
def generate_mermaid_diagram() -> str:
    """Generate the Mermaid diagram showing system architecture."""
    diagram = """```mermaid
graph TB
...
def generate_sequence_diagram() -> str:
    """Generate sequence diagram showing the two-phase workflow."""
    diagram = """```mermaid
sequenceDiagram
...
def generate_category_sources_table() -> str:
    """Generate markdown table of category-specific sources."""
    table = """
## Category-Specific Web Sources
...
def generate_integration_details() -> str:
    """Generate detailed integration information."""
    details = """
## Integration Details
...
def generate_agent_details() -> str:
    """Generate detailed agent information."""
    details = """
## Agent Details
...
def generate_workflow_description() -> str:
    """Generate detailed workflow description."""
    description = """
...
def generate_documentation() -> str:
    """Generate the complete AGENT_STRUCTURE.md content."""
    timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    
    content = f"""# Trading Card Content Generator - Agent Structure
...
{generate_agent_details()}

{generate_integration_details()}

{generate_category_sources_table()}
...
*This documentation is automatically generated. Last updated: {timestamp}*
"""
    return content


def main():
    """Main function to generate AGENT_STRUCTURE.md."""
    ...
    # Write to AGENT_STRUCTURE.md
    output_file = docs_dir / "AGENT_STRUCTURE.md"
    output_file.write_text(content, encoding="utf-8")
    
    print(f"[OK] Generated {output_file}")
    print(f"  - System architecture diagram")
    print(f"  - Two-phase workflow sequence")
    print(f"  - Data flow diagram")
    print(f"  - Agent details and responsibilities")
    print(f"  - Integration details (Neon, Context7, SEO)")
    print(f"  - Category-specific web sources")
    print(f"  - Error handling and retry logic")
    print(f"  - Configuration and deployment info")
